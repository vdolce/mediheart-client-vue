<template>
  <v-row>
        ...
        <v-col cols="12" class="pt-0 pb-0 card-container">
          ...
          >
            <v-row
              ...
              justify="center"
            >      
              <v-col cols="12" md="5" sm="12" class="pt-0 pb-0" v-bind:class="[{'text-center': $vuetify.breakpoint.smAndDown, 'text-left': $vuetify.breakpoint.mdAndUp}]">
                <h1 class="custom-title text-wrap" v-if="this.$vuetify.breakpoint.mdAndUp">{{ $t('LandingPage.title.part1') }} <br> {{ $t('LandingPage.title.part2') }}</h1>
                <h1 class="custom-title text-wrap" v-if="this.$vuetify.breakpoint.smAndDown">{{ $t('LandingPage.title.part1') }} {{ $t('LandingPage.title.part2') }}</h1>
    ...
    *******************************************************-->
    <v-col cols="12" class="pt-5 pb-5 mt-12">
      <v-row
        align="center"
        justify="center"
      >      
        <v-col cols="12" md="10" sm="12" class="pt-0 pb-0 card-container">
          <v-card            
            class="pl-3 pr-3 mt-0 pt-0 mb-0 pb-0 container"                        
            flat
            max-width="1024px"                    
      ...
      <v-col cols="12" md="10" sm="12" class="pt-0 pb-0 card-container">
          ...
          >
            ...
            <v-row
              align="start"
              justify="start"
              v-bind:class="[{'text-center': $vuetify.breakpoint.smAndDown, 'text-left': $vuetify.breakpoint.mdAndUp}]"
            >            
              <v-col cols="12" md="4" sm="12" class="pt-0 pb-0 mt-8">
                <v-img :src="require('@/assets/img/white_logo.png')" width="220" height="55" class="ml-6 footer-img"></v-img>
              </v-col>

              <!-- CONTACTS -->
              <v-col cols="12" md="3" sm="12" class="pt-0 pb-0 mt-12">
                <h3  class="white--text mb-4"> Contacts</h3>
                <ul id="contact-list" class="nobull pl-0">
                  <li v-for="item in contactList" :key="item.link" class="white--text mb-4">
                    {{ item.link }}
                  </li>
                </ul>
              </v-col>
              <!-- COMPANY -->
              <v-col cols="12" md="3" sm="12" class="pt-0 pb-0 mt-12">
                <h3  class="white--text mb-4"> Company</h3>
                <ul id="contact-list" class="nobull pl-0">
                  <li v-for="item in contactList" :key="item.link" class="white--text mb-4">
                    {{ item.link }}
                  </li>
              ...
              <!-- LEGAL -->
              <v-col cols="12" md="2" sm="12" class="pt-0 pb-0 mt-12">
                <h3  class="white--text mb-4">Legal</h3>
                <ul id="contact-list" class="nobull pl-0">
                  <li v-for="item in contactList" :key="item.link" class="white--text mb-4">
                    {{ item.link }}
                  </li>
              ...
              <v-col cols="12" md="6" sm="12" class="pt-0 pb-0" v-bind:class="[{'text-center': $vuetify.breakpoint.smAndDown, 'text-left': $vuetify.breakpoint.mdAndUp}]">
                <p class="copyright-text mt-4 mb-3 ml-2">© Digiclover - All rights reserved.</p>
              </v-col>

              <!-- social media icons  -->
              <v-col cols="12" md="6" sm="12" class="pt-0 pb-0 mt-3 mb-4" v-bind:class="[{'text-center': $vuetify.breakpoint.smAndDown, 'text-right': $vuetify.breakpoint.mdAndUp}]">
                <v-btn href="https://twitter.com/" icon target="_blank" class="mr-3">
                  <v-icon  color="white">mdi-twitter</v-icon>
                </v-btn>
                <v-btn href="https://www.facebook.com/" icon target="_blank" class="mr-3">
                  <v-icon  color="white">mdi-facebook</v-icon>
                </v-btn>
                <v-btn href="https://instagram.com/" icon target="_blank" class="mr-3">
                  <v-icon  color="white">mdi-instagram</v-icon>
                </v-btn>
                <v-btn href="https://linkedin.com/" icon target="_blank" class="mr-3">
