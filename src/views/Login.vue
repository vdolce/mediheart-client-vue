<template>
  ...
  >
    <v-list-item three-line class="mt-0">
      <v-list-item-content> 
        <v-list-item-title class="text-center custom-title">{{ $t('Login.title') }}</v-list-item-title>                        
      </v-list-item-content>          
    </v-list-item>
    ...
    <v-card-actions class="mt-6 mb-6 pl-4 pr-4">
      <v-row>            
          ...
          <v-col cols="12" >    
              <v-btn color="secondary" :to="{ name: 'signup'}" key="signup" rounded large block outlined>
